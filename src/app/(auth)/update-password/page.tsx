...
function UpdatePasswordContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        setError(data.error || "Erro ao atualizar a senha. Tente novamente.");
        return;
      }
      ...
      setTimeout(() => {
        router.push(data.destination || "/paciente");
        router.refresh();
      }, 2500);
    } catch {
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-6">
        <div className="w-full max-w-sm text-center space-y-4">
          ...
          <h2 className="text-xl font-bold text-neutral-900" data-testid="text-invalid-link">
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-6">
        <div className="w-full max-w-sm text-center space-y-4">
          ...
          <h2 className="text-xl font-bold text-neutral-900" data-testid="text-password-updated">
            Senha atualizada!
          </h2>
          <p className="text-sm text-neutral-500">
        ...
        <div className="w-full max-w-sm space-y-8">
          <div>
            ...
            <h1
              ...
              data-testid="text-update-password-title"
            >
              Nova Senha
            </h1>
