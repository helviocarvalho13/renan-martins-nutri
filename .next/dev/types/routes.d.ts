...
type AppRouteHandlerRoutes = "/api/admin/appointments" | "/api/admin/patients/search" | "/api/appointments" | "/api/appointments/[id]" | "/api/auth/login" | "/api/available-slots" | "/api/cron/reminders" | "/api/patient/book" | "/api/patient/cancel" | "/api/patient/return-eligibility" | "/api/seed-admin" | "/api/settings" | "/api/setup"
