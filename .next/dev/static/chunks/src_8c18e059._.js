...
"[project]/src/app/(public)/agenda/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AgendaPage() {
    ...
    const [schedule, setSchedule] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(fallbackSchedule);
            ...
            async function load() {
                try {
                    ...
                    if (apptData) {
                        const counts = {};
                        apptData.forEach({
                            "AgendaPage.useEffect.load": (a)=>{
                                counts[a.date] = (counts[a.date] || 0) + 1;
                            }
                        }["AgendaPage.useEffect.load"]);
    ...
    const activeDays = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AgendaPage.useMemo[activeDays]": ()=>new Set(schedule.filter({
                "AgendaPage.useMemo[activeDays]": (s)=>s.is_active
            }["AgendaPage.useMemo[activeDays]"]).map({
                "AgendaPage.useMemo[activeDays]": (s)=>s.day_of_week
            }["AgendaPage.useMemo[activeDays]"]))
    }["AgendaPage.useMemo[activeDays]"], [
        schedule
    ]);
    const blockedFullDays = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AgendaPage.useMemo[blockedFullDays]": ()=>{
            const set = new Set();
            blockedSlots.forEach({
                "AgendaPage.useMemo[blockedFullDays]": (b)=>{
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            `,
                                                            ...
                                                            children: [
                                                                day.getDate(),
                                                                status !== "past" && status !== "unavailable" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: DAY_NAMES_FULL.map((name, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AgendaPage, "yxfiASI41U3ULGQfc98i6F4HinY=");
_c = AgendaPage;
var _c;
...
//# sourceMappingURL=src_8c18e059._.js.map