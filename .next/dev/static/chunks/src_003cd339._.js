    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UpdatePasswordPage.useEffect": ()=>{
            ...
            supabase.auth.getSession().then({
                "UpdatePasswordPage.useEffect": ({ data: { session } })=>{
                    setHasSession(!!session);
                    setChecking(false);
                }
            }["UpdatePasswordPage.useEffect"]);
            const { data: { subscription } } = supabase.auth.onAuthStateChange({
                "UpdatePasswordPage.useEffect": (event, session)=>{
            ...
            return ({
                "UpdatePasswordPage.useEffect": ()=>subscription.unsubscribe()
            })["UpdatePasswordPage.useEffect"];
        }
    }["UpdatePasswordPage.useEffect"], []);
...
_s(UpdatePasswordPage, "81K80FqBNMuOC6JLZJwVbMGyFW4=", false, function() {
    return [
...
//# sourceMappingURL=src_003cd339._.js.map