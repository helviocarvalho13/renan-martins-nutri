...
function RegisterPage() {
    ...
    const handleRegister = async (e)=>{
        ...
        setLoading(true);
        try {
            const { data, error: signUpError } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signUpWithProfile"])({
                name: fullName.trim(),
                email: email.trim(),
                password,
                phone: phoneDigits,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8615cbcb._.js.map