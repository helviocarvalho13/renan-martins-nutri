...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        setLoading(true);
        try {
            const { data, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authClient"].signIn.email({
                email: email.trim(),
                password
            });
            if (authError || !data) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2858bc9e._.js.map