...
function createClient() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createBrowserClient"])(("TURBOPACK compile-time value", "https://smvdxecclhlvzuzebhwm.supabase.co"), ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNtdmR4ZWNjbGhsdnp1emViaHdtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI2NDAwNTgsImV4cCI6MjA4ODIxNjA1OH0.1YucSYgB3MYTNxT7FxxNdO8GMeYiwOMKjUkxOuGoZl0"));
}
}),
...
function useMageBot() {
    ...
    const performBooking = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (ctx)=>{
        ...
        if (!token) {
            const errorResponse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$chatbot$2f$engine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBookingErrorResponse"])(ctx, "Sua sessão expirou. Faça login novamente.");
            addBotMessages(errorResponse.messages, errorResponse.context, errorResponse.quickReplies);
            return;
        }
        try {
        ...
        if (isPasswordInput && context.loginEmail) {
            try {
                ...
                if (error || !data.user || !data.session) {
                    const failResponse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$chatbot$2f$engine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLoginFailureResponse"])(context, error?.message);
...
//# sourceMappingURL=src_5c3575ac._.js.map