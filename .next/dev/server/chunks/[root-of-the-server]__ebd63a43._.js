...
async function POST(request) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createServiceRoleClient"])();
    const { data: appointment, error: fetchError } = await supabase.from("appointments").select("*").eq("id", appointment_id).single();
    ...
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notifyAppointmentCancelledByPatient"])(user.id, dateFormatted, timeFormatted, appointment_id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ebd63a43._.js.map