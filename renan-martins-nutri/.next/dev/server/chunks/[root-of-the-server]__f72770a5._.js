...
async function GET() {
    ...
    const { data: profile } = await supabase.from("profiles").select("full_name, phone, cpf, date_of_birth").eq("id", user.id).single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f72770a5._.js.map