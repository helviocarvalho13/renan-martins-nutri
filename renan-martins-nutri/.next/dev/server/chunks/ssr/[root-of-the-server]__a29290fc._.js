...
async function handleSelectDate(input, context) {
    ...
    if (slots.length === 0) {
        ...
        const suggestionMessages = suggestions.length > 0 ? [
            `Nao ha horarios disponiveis para ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$chatbot$2f$dateParser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatDatePtBr"])(parsed)}.`,
            `Proximos dias disponiveis: ${suggestions.map((s)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$chatbot$2f$dateParser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatDatePtBr"])(new Date(s + "T12:00:00"))).join(", ")}`
        ] : [
            `Nao ha horarios disponiveis para ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$chatbot$2f$dateParser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatDatePtBr"])(parsed)}. Tente outra data.`
        ];
    ...
    return {
        messages: [
            `Horarios disponiveis para ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$chatbot$2f$dateParser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatDatePtBr"])(parsed)}:`,
            "Escolha um horario:"
        ],
        context: {
            ...context,
...
async function handleConfirm(input, context) {
    if (input === "sim" || input === "confirmar" || input.includes("confirm")) {
        ...
        if (result.success) {
            const dateFormatted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$chatbot$2f$dateParser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatDatePtBr"])(new Date(context.selectedDate + "T12:00:00"));
            return {
                messages: [
...
function createClient() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createBrowserClient"])(("TURBOPACK compile-time value", "https://dvrwltbunfwnymoqrqzg.supabase.co"), ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImR2cndsdGJ1bmZ3bnltb3FycXpnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI1ODA1OTYsImV4cCI6MjA4ODE1NjU5Nn0.dAOqu824PidFe-KtDxSPaMV42JUaziZII9BVNh5izDw"));
}
}),
...
function useMageBot() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const checkAuth = async ()=>{
            ...
            let newContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$chatbot$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createInitialContext"])();
            if (user) {
    ...
    const setOpen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((open)=>{
        setIsOpen(open);
        if (open) {
            setUnreadCount(0);
            if (!hasGreeted.current) {
...
function MageBotWidget() {
    const { messages, quickReplies, isTyping, isOpen, unreadCount, sendMessage, toggleOpen, setOpen } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useMageBot$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMageBot"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a29290fc._.js.map