module.exports = [
"[project]/node_modules/better-auth/node_modules/@better-auth/memory-adapter/dist/index.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const memoryAdapter = (db, config)=>{
    ...
    const adapterCreator = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$adapter$2f$factory$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["createAdapterFactory"])({
        config: {
            adapterId: "memory",
        ...
        adapter: ({ getFieldName, getDefaultFieldName, options, getModelName })=>{
            ...
            function convertWhereClause(where, model, join, select) {
                const baseRecords = (()=>{
                    ...
                    if (!table) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$env$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["logger"].error(`[MemoryAdapter] Model ${model} not found in the DB`, Object.keys(db));
                ...
                for (const baseRecord of baseRecords){
                    ...
                    for (const [joinModel, joinAttr] of Object.entries(join)){
                        ...
                        if (!joinTable) {
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$env$2f$logger$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["logger"].error(`[MemoryAdapter] JoinOption model ${joinModelName} not found in the DB`, Object.keys(db));
...
//# sourceMappingURL=4c5a8_%40better-auth_memory-adapter_dist_index_mjs_d7d5e49c._.js.map