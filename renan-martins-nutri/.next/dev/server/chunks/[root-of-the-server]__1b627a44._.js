...
"[project]/src/app/api/admin/patients/search/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    let query = supabase.from("profiles").select("id, full_name, email, phone, cpf").eq("role", "PATIENT").eq("is_active", true).limit(10);
    if (isCpfSearch) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1b627a44._.js.map