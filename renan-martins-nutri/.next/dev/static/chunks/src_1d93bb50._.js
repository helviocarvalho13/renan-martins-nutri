...
function AgendaPage() {
    ...
    const updateAppointment = async (updates)=>{
        ...
        setUpdating(true);
        const { error } = await supabase.from("appointments").update(updates).eq("id", selectedAppointment.id);
        if (!error) {
...
_s(AgendaPage, "b+H2QlTvPC5vjLdI4TfNydhVS/k=");
_c = AgendaPage;
var _c;
...
//# sourceMappingURL=src_1d93bb50._.js.map